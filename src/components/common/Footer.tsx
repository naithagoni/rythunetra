    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span className="text-lg font-bold tracking-tight select-none">
                                ...
                                <span className="text-neutral-400">Netra</span>
                            </span>
                        </Link>
                ...
                <div className="border-t border-white/[0.06] mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
