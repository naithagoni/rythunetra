...
version: alpha
name: Geist
description: Vercel’s Geist design system, Dark theme (the Light theme is documented at design.light.md).
colors:
  primary: "#ededed"
  secondary: "#a0a0a0"
  tertiary: "#006efe"
...
typography:
  heading-72:
    fontFamily: Geist Sans, Anek, system-ui, -apple-system, sans-serif
    fontSize: 72px
    fontWeight: 600
    lineHeight: 72px
...
Geist Sans, Anek sets UI and prose; Geist Mono sets code, data, and tabular figures. Both are open-source. The `typography` tokens above carry concrete `fontFamily`, `fontSize`, `fontWeight`, `lineHeight`, and `letterSpacing`:
